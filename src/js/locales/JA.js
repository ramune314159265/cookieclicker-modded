AddLanguage('JA','japanese',{
	...
	"Squish the news ticker flat, then click on it.": "ニュースのティッカーを平らに潰してクリックする。",
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>": "クッキーの提供でお届けしました <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>",
