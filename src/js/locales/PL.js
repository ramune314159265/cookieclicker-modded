AddLanguage('PL','polish',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>": "Jest list do ciebie <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>",
