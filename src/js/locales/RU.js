AddLanguage('RU','russian',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>": "Принесено вам в письме <div style=\"display:inline-block;background:url(images/money.png);width:16px;height:16px;\"></div>",
